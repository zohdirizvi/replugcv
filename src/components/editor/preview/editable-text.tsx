...
function FormatToolbar({ targetRef }: { targetRef: React.RefObject<HTMLElement | null> }) {
  ...
  return (
    <div
      className="absolute -bottom-7 left-1/2 -translate-x-1/2 z-50 flex items-center gap-0.5 rounded-md border border-[#E5E5E5] bg-white px-1 py-0.5 shadow-lg"
      data-format-toolbar
  ...
  const editableElement = (
    <Tag
      ...
      style={{
        ...
        minWidth: showPlaceholder && !isBlockTag ? "30px" : undefined,
        minHeight: "1em",
        maxWidth: "100%",
